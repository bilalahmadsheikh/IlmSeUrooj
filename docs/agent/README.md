...
## What Is UniMatch?
A Chrome extension + Next.js backend that autofills Pakistani university application forms from a single student profile using AI field mapping via Claude Haiku.
...
| AI Field Mapping | 3 | Claude Haiku maps forms, 8 transforms, answer memory |
