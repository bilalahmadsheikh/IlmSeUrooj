/**
 * SZABIST Islamabad
 * Portal: szabist-isb.edu.pk admissions
 * Type: Login-first
 */
const szabist_isb = {
    slug: 'szabist-isb',
    name: 'SZABIST Islamabad',
    fullName: 'Shaheed Zulfikar Ali Bhutto Institute of Science and Technology — Islamabad',
    ...
    notes: 'Spring 2026 admissions open. Islamabad campus. Login-first system.'
};

export default szabist_isb;
