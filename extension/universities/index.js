...
ALL_UNIVERSITIES.push({
    ...
    fieldMap: {
        ...
        cnic: '[name="cnic"], [name="cnic_no"], [name="CNIC"], [name="ApplicantCNIC"], #cnic, #cnic_no',
        date_of_birth: '[name="dob"], [name="date_of_birth"], [name="DOB"], [name="DateOfBirth"], [name="BirthDate"], #dob, #DOB',
        gender: '[name="gender"], [name="Gender"], [name="sex"], #gender',
        email: '[name="email"], [name="Email"], [type="email"], #email',
        phone: '[name="mobile"], [name="Mobile"], [name="phone"], [name="cell"], [name="MobileNo"], [name="PhoneNo"], #mobile, #phone',
        address: '[name="address"], [name="Address"], [name="permanent_address"], [name="PermanentAddress"], #address',
        city: '[name="city"], [name="City"], #city',
        province: '[name="province"], [name="Province"], [name="domicile"], #province, select[id*="Province"], select[id*="ddlProvince"], select[id*="DomicileProvince"], select[id*="ddlDomicileProvince"]',
        postal_code: '[name="postal_code"], [name="PostalCode"], [name="zip"], #postal_code',
        fsc_marks: '[name="fsc_marks"], [name="hssc_marks"], [name="InterMarks"], [name="FSCMarks"], #fsc_marks',
        fsc_total: '[name="fsc_total"], [name="hssc_total"], [name="InterTotal"], #fsc_total',
        matric_marks: '[name="matric_marks"], [name="ssc_marks"], [name="MatricMarks"], #matric_marks',
        matric_total: '[name="matric_total"], [name="ssc_total"], [name="MatricTotal"], #matric_total',
        board_name: '[name="board"], [name="board_name"], [name="Board"], [name="InterBoard"], #board',
        passing_year: '[name="passing_year"], [name="year"], [name="PassingYear"], #passing_year',
        net_score: '[name="net_score"], [name="test_score"], [name="NETScore"], [name="TestScore"], #net_score',
        domicile_province: '[name="domicile"], [name="domicile_province"], [name="DomicileProvince"], #domicile',
        father_occupation: '[name="father_profession"], [name="FatherProfession"], [name="father_occupation"], [name="FatherOccupation"], [name="FatherJob"], select[id*="FatherProfession"], select[id*="FatherOccupation"], select[id*="ddlFatherProf"], select[id*="ddlFatherOcc"]',
        father_status: '[name="father_status"], [name="FatherStatus"], [name="IsFatherAlive"], [name="FatherAlive"], select[id*="FatherStatus"], select[id*="IsFatherAlive"], select[id*="ddlFatherStatus"]',
        father_income: '[name="father_income"], [name="FatherIncome"], [name="FatherSalary"], [name="FatherMonthlyIncome"], select[id*="FatherIncome"], select[id*="FatherSalary"], select[id*="ddlFatherIncome"], select[id*="Father"][id*="Income"], select[id*="Father"][id*="Salary"], select[id*="father"][id*="income"], select[id$="ddIncomeRange"]',
        mother_profession: '[name="mother_profession"], [name="MotherProfession"], [name="mother_occupation"], [name="MotherOccupation"], select[id*="MotherProfession"], select[id*="MotherOccupation"], select[id*="ddlMotherProf"]',
        mother_status: '[name="mother_status"], [name="MotherStatus"], [name="IsMotherAlive"], [name="MotherAlive"], select[id*="MotherStatus"], select[id*="IsMotherAlive"], select[id*="ddlMotherStatus"]',
        mother_income: '[name="mother_income"], [name="MotherIncome"], [name="MotherSalary"], [name="MotherMonthlyIncome"], select[id*="MotherIncome"], select[id*="MotherSalary"], select[id*="ddlMotherIncome"], select[id*="Mother"][id*="Income"], select[id*="Mother"][id*="Salary"], select[id*="mother"][id*="income"]',
        education_system: '[name="education_system"], [name="EducationSystem"], [name="AcademicBackground"], [name="academic_background"], [name="QualificationType"], select[id*="AcademicBackground"], select[id*="EducationSystem"], select[id*="QualificationType"], select[id*="ddlAcademic"], input[id*="rblAcademic"], input[id*="rdoAcademic"], input[id*="rblQual"], input[id*="rdoQual"], input[id*="rblInter"], input[id*="rblPrev"]',
        district: '[name="district"], [name="District"], [name="domicile_district"], select[id*="ddlDistrict"], select[id*="District"]',
    },
    selectOptions: {
