...
ALL_UNIVERSITIES.push({
    ...
    fieldMap: {
        ...
        province: '[name="province"], [name="Province"], [name="domicile"], #province',
        ...
        father_occupation: '[name="father_profession"], [name="FatherProfession"], [name="father_occupation"], [name="FatherOccupation"], [name="FatherJob"]',
        father_status: '[name="father_status"], [name="FatherStatus"], [name="IsFatherAlive"], [name="FatherAlive"]',
        mother_profession: '[name="mother_profession"], [name="MotherProfession"], [name="mother_occupation"], [name="MotherOccupation"]',
        mother_status: '[name="mother_status"], [name="MotherStatus"], [name="IsMotherAlive"], [name="MotherAlive"]',
        education_system: '[name="education_system"], [name="EducationSystem"], [name="AcademicBackground"], [name="academic_background"], [name="QualificationType"]',
    },
    selectOptions: {
