...
ALL_UNIVERSITIES.push({
    ...
    fieldMap: {
        ...
        father_income: '[name="father_income"], [name="FatherIncome"], [name="FatherSalary"], [name="FatherMonthlyIncome"], select[id*="FatherIncome"], select[id*="FatherSalary"], select[id*="ddlFatherIncome"], select[id*="Father"][id*="Income"], select[id*="Father"][id*="Salary"], select[id*="father"][id*="income"]',
