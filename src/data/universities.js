...
export const universities = [
  // === NUST (Single Campus) ===
  {
    ...
    admissions: {
      ...
      testSeries: [
        ...
        { series: "Series IV",   deadline: "2026-06-18", testDate: "2026-06-13" },
  ...
  // === PIEAS (Single Campus) ===
  {
    ...
    admissions: {
      ...
      testDate: "2026-06-12",
      testSeries: [
        { series: "Test I",   deadline: "2026-03-05", testDate: "2026-04-12" },
        { series: "Test II",   deadline: "2026-06-12", testDate: "2026-06-12" }
      ],
  ...
  // === Bahria Campuses ===
  {
    ...
    admissions: {
      ...
      testDate: "2026-07-24",
      testSeries: [
        { series: "BUET I",   deadline: null, testDate: "2026-06-19" },
        { series: "BUET I",   deadline: null, testDate: "2026-06-20" },
        { series: "BUET II",   deadline: null, testDate: "2026-07-24" },
  ...
  },
  {
    ...
    admissions: {
      ...
      testSeries: [
        { series: "BUET I",   deadline: null, testDate: "2026-06-20" },
        { series: "BUET II",   deadline: null, testDate: "2026-08-01" },
        { series: "BUET III",   deadline: null, testDate: "2026-09-05" }
      ],
      applyUrl: "https://cms.bahria.edu.pk/Logins/candidate/Login.aspx",
      lastVerified: "2026-07-21"
    }
  },
  {
    ...
    admissions: {
      ...
      testDate: "2026-07-27",
      testSeries: [
        { series: "BUET II",   deadline: null, testDate: "2026-07-27" }
      ],
      applyUrl: "https://cms.bahria.edu.pk/Logins/candidate/Login.aspx",
      lastVerified: "2026-07-21"
    }
  ...
  },
  {
    ...
    admissions: {
      ...
      testDate: "2026-07-11",
      testSeries: [
        { series: "BSCS/BSAI/BSSE/BSCE/BSEE",   deadline: null, testDate: "2026-07-11" },
...
export const lastScraperRun = "2026-07-21";
