...
export const entryTestsDisplay = [
    ...
    { id: "giki-test",  name: "GIKI Entry Test",            conductor: "GIKI",                    icon: "🏔️", period: "July (annually)",                              description: "GIKI's own admission test for engineering and CS programs. MCQ + Subjective, 200 marks, 3 hours. Covers Maths, Physics, English & Intelligence. Test weight: 85%.",           acceptedBy: ["GIKI"],                                              website: "https://giki.edu.pk/admissions" },
    ...
    { id: "pieas-test", name: "PIEAS Written Test",         conductor: "PIEAS",                   icon: "⚛️", period: "April (annually)",                              description: "PIEAS admission test for Nuclear, Mechanical, Electrical, CS, and Chemical Engineering. MCQ + Descriptive, 200 marks, 3 hours. Test weight: 85%.",                            acceptedBy: ["PIEAS"],                                             website: "https://admissions.pieas.edu.pk" },
    ...
    { id: "air-test",   name: "Air University Entry Test",  conductor: "Air University",          icon: "✈️", period: "June – July (annually)",                      description: "Air University's admission test for Aerospace, CS, SE, EE, and Business programs. MCQ-based, 100 marks, 1.5 hours. Air Force affiliated.",                                    acceptedBy: ["Air University"],                                    website: "https://au.edu.pk" },
];
