...
export const entryTestsDisplay = [
    ...
    { id: "giki-test",  name: "GIKI Entry Test",            conductor: "GIKI",                    icon: "", period: "July (annually)",                              description: "GIKI's own admission test for engineering and CS programs. MCQ + Subjective, 200 marks, 3 hours. Covers Maths, Physics, English & Intelligence. Test weight: 85%.",           acceptedBy: ["GIKI"],                                              website: "https://giki.edu.pk/admissions" },
